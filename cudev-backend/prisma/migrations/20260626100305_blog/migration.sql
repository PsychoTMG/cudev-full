/*
  ...
  - Added the required column `fullDesc` to the `Blog` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "fullDesc" TEXT NOT NULL,
